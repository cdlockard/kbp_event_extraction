...
def get_files_annotated_text(files):
	...
	for filename in files:
		...
		annotated_text = nlp.annotate(stripped_text, properties={'timeout': 9999, 'annotators': 'tokenize, ssplit, pos, depparse, lemma, ner, parse', 'outputFormat': 'json'})
...
def save_EAL_data_pickle(eal_files, savefile):
	eal_file = "../../datasets/eal/" + savefile + '.pkl'
...
def read_all_filenames():
	parent_directory = '/projects/WebWare6/KBP_2016/LDC2016E63_TAC_KBP_2016_Evaluation_Source_Corpus_V1.1/data/eng/'
	...
	for i, tranch in enumerate(tranches):
		...
		save_EAL_data_pickle(tranch, 'full_parse_small_tranch' + str(i))	
